        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <% Produit p = (Produit)request.getAttribute("obj"); %>
              <form role="form" action="Produit/update">
              	<input type="hidden" name="idP" value="<%= p.getId()%>">	
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Designation</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="nom produit" name="desgn" value="<%= p.getDesig()%>">
                  </div>
                  <%Vector<Categorie>vec = (Vector<Categorie>)request.getAttribute("categorie"); %>
                  <div class="form-group">
                    <label>Categorie:</label>
                    <select class="form-control" name="cat" value="<%= p.getCategorie()%>">
                    		<%
								for(Categorie t : vec){
							%>
                  ...
                  <div class="form-group">
                    <label>Etat:</label>
                    <select class="form-control" name="stat" value="<%= p.getStatut()%>">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" placeholder="Enter ..." name="com" ><%= p.getCommentaire()%></textarea>
                  </div>

...
Categorie tu = (Categorie)request.getAttribute("ut");
%>
  <meta charset="utf-8">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <input type="hidden" name="id" value="<%= tu.getId()%>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Categorie</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"   name="type" value="<%= tu.getDesig() %>">
                  </div>

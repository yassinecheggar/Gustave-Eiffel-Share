...
<% User u = (User)request.getAttribute("user"); 
	Emprunt e = (Emprunt)request.getAttribute("emp");
%>
  <meta charset="utf-8">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modifier Emprunt</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="idproduit" >
                    		<%
								for(Produit t : vec){
							%>
										<option value="<%=t.getId()%>"><%= t.getDesig() %></option>

										<%} %>
                    </select>
                  </div>
                  
                  <%Vector<User>ve = (Vector<User>)request.getAttribute("us"); %>
                   <div class="form-group">
                   ...
                   <option selected hidden>Choose here</option>
								...
								for(User a: ve){
							%>
										<option value="<%=a.getIdUser()%>"><%= a.getLogin() %></option>

...
UserType tu = (UserType)request.getAttribute("ut");%>
  <meta charset="utf-8">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modifier Type d'Utilisateur</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="update">
              <input type="hidden" name="id" value="<%= tu.getUserTypeId()%>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Type</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="type" value="<%= tu.getType() %>">
                  </div>

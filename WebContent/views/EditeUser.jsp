...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <%
						User p = (User) request.getAttribute("obj");
					%>
      <div class="container-fluid">
        <div class="row">
          <!-- left column -->
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="User/update">
              	<input type="hidden" name="idP" value="<%=p.getIdUser()%>">
				<input type="hidden" name="Ps" value="<%=p.getPasseword()%>">
				<input type="hidden" name="log" value="<%=p.getLogin()%>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nom</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="nom produit" name="nom"
										value="<%=p.getNom()%>">
                  </div>
                 ...
                 <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="nom produit" name="Pnom"
										value="<%=p.getPrenom()%>">
                  </div>
                	...
                	<%
								Vector<UserType> vec = (Vector<UserType>) request.getAttribute("categorie");
							%>
                 <div class="card-body">
               <div class="form-group">
                    <label>Etat:</label>

...
Vector<Categorie>vec = (Vector<Categorie>)request.getAttribute("type");
%>
<meta charset="utf-8">
...
function myFunction() {
  var txt;
  if (confirm("Press a button ok  to  delete")) {
	  return true;
  } else {
	  ...
	  return false;
			...
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Liste Categorie Produit</h3>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
                  ...
                  %>
                    <tr>
                      <td><%= c.getId() %></td>
                      <td><%= c.getDesig() %></td>
                      <td><form action="delete"  name="forma" onsubmit="return myFunction()" >
                      <input type="hidden" name="ed" value="<%=c.getId() %>"/>

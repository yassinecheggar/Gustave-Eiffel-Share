...
Vector<Produit> prod = (Vector<Produit>) request.getAttribute("produit");
				...
				<div class="card-body">
                  ...
                  %>
							<tr>
								...
								<td><%= t.getStatut() %></td>
								<td><%= t.getEtat() %></td>
								<td><%= t.getCommentaire()%></td>
								<td>
								
								<form action="Produit/delete" name="forma"
													onsubmit="return myFunction()">
													<input type="hidden" name="ed" value="<%=t.getId() %>" /> <input

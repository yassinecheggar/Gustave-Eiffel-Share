...
Vector<User> prod = (Vector<User>) request.getAttribute("Users");
			...
			<div class="card">
				...
				<div class="card-body">
                  ...
                  <% for(User t : prod){ 
                	  String s="";
                	  for(UserType c : vec){
                		 if(c.getUserTypeId() == t.getUserType())
                		 s=c.getType();
                	  }
                  %>
                    <tr>
                      ...
                      <td><%= s %></td>
                      <td>
                      <form action="User/delete"  name="forma" onsubmit="return myFunction()">
                      <input type="hidden" name="ed" value="<%=t.getIdUser() %>"/>

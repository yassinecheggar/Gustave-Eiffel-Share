...
public interface IProduit extends Remote {
	...
	public Vector<Produit> getProduitID(int id)throws RemoteException;
	...
	public Vector<Produit> getProduitwithuser(int iduser)throws RemoteException;
	public Vector<Produit> ProduitwithCat(int cat)throws RemoteException;
